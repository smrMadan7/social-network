  ...
  return (
    <>
      {!appState?.action?.user ? (
        ...
        <>
          <div className="md:hidden absolute bottom-0 w-full flex  justify-around bg-white border-t py-2">
            <NavLink to={"/home"}>
              <div
            ...
            <div>
              <li
                className="flex flex gap-2 items-center justify-center cursor-pointer hover:bg-bgHover hover:rounded-lg px-3 py-1 "
